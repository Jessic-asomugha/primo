        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="max-w-3xl flex flex-col justify-center">
            ...
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-brand-orange mb-2 block">
              Corporate Background &amp; Compliance Heritage
            </span>
            <h1 className="text-display text-4xl sm:text-5xl font-extrabold tracking-tight text-white leading-[1.1] mb-6">
              Built on Traceability, <br />
              <span className="text-slate-400">Engineered for Absolute Fuel Security.</span>
            </h1>
            <p className="text-slate-400 text-sm leading-relaxed max-w-2xl font-light">
              Primo has established itself as Abuja&apos;s leading logistics partner for premium Automotive Gas Oil (AGO). Leveraging high-precision telemetry, regulatory certified metering, and our rigorous multi-stage laboratory filtration system, we keep critical infrastructure, hotels, and healthcare facilities running at 100% capacity.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          ...
          <div className="flex flex-col gap-4 mb-16 max-w-xl">
            ...
            <h3 className="text-3xl font-extrabold text-slate-900 tracking-tight">
              Our Core Fuel Guardrails
            </h3>
            <p className="text-slate-500 text-sm leading-relaxed font-light">
              Every liter of fuel in our tankers, every telemetry audit on our client dashboards, and every regional dispatch coordinate is bound by four absolute operational rules.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="flex flex-col gap-6">
              ...
              <h2 className="text-display text-3xl font-bold tracking-tight text-slate-900 leading-tight">
                Why Abuja Operators Mandate Primo.
              </h2>
              <p className="text-slate-600 text-sm leading-relaxed">
                In heavy industry, backup generator power isn&apos;t a luxury—it&apos;s a survival threshold. We align our delivery speeds with absolute risk mitigation processes.
              </p>
                ...
                {[
                  {
                    ...
                    title: '4-Hour Initial Dispatch Desk',
                    desc: 'We operate a dedicated municipal fuel logistics dispatch desk. Submit your fuel requirement and expect delivery within 4 operational hours.'
                  },
                  {
                    icon: <FileText className="h-5 w-5 text-brand-orange shrink-0 mt-0.5" />,
                    title: 'Absolute Fuel Traceability Binder',
                    desc: 'We supply certified chemical and laboratory test certificates for every batch of AGO dispatched. Total verification, zero guesswork.'
                  },
                  {
                    icon: <UserCheck className="h-5 w-5 text-brand-orange shrink-0 mt-0.5" />,
                    title: 'Professional Tanker Captains',
                    desc: 'Every truck driver at Primo undergoes quarterly defensive city transit tests, security screening, and regulatory safety training.'
                  }
                ].map((highlight, index) => (
            ...
            <div className="flex flex-col gap-6 bg-slate-900 text-white p-8 rounded-lg border border-slate-800 shadow-xl relative overflow-hidden">
              ...
              <p className="text-slate-300 text-xs leading-relaxed">
                We distribute products strictly matching Nigerian Midstream and Downstream Petroleum Regulatory Authority (NMDPRA) quality templates.
              </p>

              <div className="grid grid-cols-2 gap-4 mt-2 text-xs">
                <div className="p-4 rounded bg-slate-950 border border-slate-800">
                  <span className="text-[10px] text-brand-orange font-mono font-bold block mb-1">REGULATORY COMPLIANCE</span>
                  <span className="font-semibold text-white block">NMDPRA REGISTERED</span>
                  <p className="text-[10px] text-slate-500 mt-1">Legally authorized down-stream distribution license AGO-DFL-2026.</p>
                </div>
                <div className="p-4 rounded bg-slate-950 border border-slate-800">
                  <span className="text-[10px] text-brand-orange font-mono font-bold block mb-1">FUEL PURITY SPEC</span>
                  <span className="font-semibold text-white block">NIS 554 LOW-SULFUR</span>
                  <p className="text-[10px] text-slate-500 mt-1">Low-sulfur automotive gas oil ensuring minimal wear on injectors.</p>
                </div>
                <div className="p-4 rounded bg-slate-950 border border-slate-800">
                  <span className="text-[10px] text-brand-orange font-mono font-bold block mb-1">VOLUME TRANSPARENCY</span>
                  <span className="font-semibold text-white block">DIGITAL FLOW CALIBRATED</span>
                  <p className="text-[10px] text-slate-500 mt-1">Calibrated digital custody flow meters certified semi-annually.</p>
                </div>
                <div className="p-4 rounded bg-slate-950 border border-slate-800">
                  <span className="text-[10px] text-brand-orange font-mono font-bold block mb-1">STUTTGART PIPELINE DESK</span>
                  <span className="font-semibold text-white block">ISO 9001 METEOROLOGY</span>
                  <p className="text-[10px] text-slate-500 mt-1">Calibrated engineering support and volume logistics coordination.</p>
                </div>
              </div>
            </div>
