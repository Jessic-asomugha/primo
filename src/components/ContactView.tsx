...
export default function ContactView({ selectedServiceInquiry, setSelectedServiceInquiry }: ContactViewProps) {
  ...
  const [serviceInterest, setServiceInterest] = useState(selectedServiceInquiry || 'General Inquiry');
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="max-w-3xl flex flex-col justify-center">
            ...
            <h1 className="text-display text-4xl sm:text-5xl lg:text-5.5xl font-extrabold tracking-tight text-white leading-[1.1] mb-6">
              Initiate Fuel <br />
              <span className="text-slate-400">Logistics &amp; Quote Request.</span>
            </h1>
            <p className="text-slate-400 text-sm sm:text-base leading-relaxed max-w-2xl font-light">
              Submit your monthly consumption parameters, delivery schedule, or corporate tenders. Our Abuja logistics dispatch desk will review and reply with a validated quote under our 4-hour response SLA.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-5 flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-2">
                ...
                <h2 className="text-display text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">
                  Primo Dispatch Directories
                </h2>
                <p className="text-slate-500 text-xs font-light leading-relaxed">
                  Connect with our dedicated division representatives or transmit encrypted monthly fuel estimates directly to our central Abuja desk.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-8 border-l border-slate-200 pl-6 relative">
                ...
                <div className="group relative">
                  <span className="text-[9px] font-mono font-bold text-slate-400 tracking-widest uppercase block mb-1">
                    [02] DIRECT DISPATCH CO-ORDINATES
                  </span>
                  <h4 className="font-bold text-slate-900 uppercase tracking-wider text-xs">
                    Voice &amp; Electronic Gateway
                  </h4>
                  <p className="text-slate-500 text-xs mt-2 leading-relaxed font-light">
                    Corporate Registry: <span className="font-semibold text-slate-900">+234 (0) 9 460-2300</span><br />
                    24/7 Dispatch Hotline: <span className="font-semibold text-slate-900">+234 (0) 803 555-0192</span><br />
                    Technical RFPs: <span className="font-semibold text-slate-900">enquiries@primo-logistics.com</span>
                  </p>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="space-y-2 text-xs font-light text-slate-500">
                    <div className="flex justify-between items-center border-b border-slate-100 pb-1">
                      <span>Standard Dispatch Hours</span>
                      <span className="font-mono text-slate-900 font-medium">07:00 – 19:00 // M-Sat</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-slate-100 pb-1">
                      <span>RFP Evaluation Turnaround</span>
                      <span className="font-mono text-brand-orange font-bold">Under 4 Hours</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span>Emergency Operations Hotline</span>
                      <span className="font-mono text-slate-900 font-medium">24/7 Standby Patrol</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="relative h-[400px] sm:h-[480px] w-full rounded border border-slate-200 bg-slate-950 overflow-hidden shadow-lg flex items-center justify-center">
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center">
              ...
              <div className="mt-3.5 bg-slate-900/95 border border-brand-orange/40 text-white px-4 py-2.5 rounded shadow-2xl text-[10px] font-mono tracking-widest text-center uppercase whitespace-nowrap">
                <span className="font-bold text-white block text-xs tracking-wider">PRIMO HUB ABUJA [HQ]</span>
