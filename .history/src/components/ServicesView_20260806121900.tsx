      ...
      <section className="relative gradient-primary text-white py-24 border-b border-slate-800 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="max-w-3xl flex flex-col justify-center animate-fade-in-up">
            ...
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] gradient-text mb-2 block">
            ...
            <p className="text-slate-300 text-sm leading-relaxed max-w-2xl font-light">
              Capella provides integrated business solutions across oil and gas, procurement, logistics, engineering, construction support, and general contracting.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          ...
          <div className="flex flex-col gap-3 mb-10">
            ...
            <p className="text-slate-500 text-sm font-light max-w-2xl leading-relaxed">
              Explore the currently confirmed service information. Additional details will be published when confirmed by the client.
            </p>
          </div>
      ...
      <section className="bg-slate-900 text-white py-16 border-t border-slate-800">
        <div className="mx-auto max-w-4xl px-6 sm:px-8 lg:px-12 text-center flex flex-col items-center gap-5">
          ...
          <p className="text-slate-300 max-w-xl text-xs leading-relaxed font-light">
            Contact Capella Integrated Global Limited to discuss solutions tailored to your organisation.
          </p>
          <button
