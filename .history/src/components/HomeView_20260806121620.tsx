      ...
      <section className="gradient-primary text-white py-16 border-b border-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
            ...
            <div className="flex flex-col gap-1 border-l-4 border-gradient-to-r from-brand-orange to-brand-accent pl-6 glass-dark p-4 rounded-lg card-hover animate-fade-in-up" style={{animationDelay: '0.1s'}} id="trust-stat-liters">
            ...
            <div className="flex flex-col gap-1 border-l-4 border-gradient-to-r from-brand-orange to-brand-accent pl-6 glass-dark p-4 rounded-lg card-hover animate-fade-in-up" style={{animationDelay: '0.2s'}} id="trust-stat-response">
              <span className="text-display text-3xl sm:text-4xl font-extrabold tracking-tight gradient-text font-mono">
                5 States
              </span>
              <span className="text-[10px] uppercase tracking-[0.15em] text-slate-300 font-mono">
            ...
            <div className="flex flex-col gap-1 border-l-4 border-gradient-to-r from-brand-orange to-brand-accent pl-6 glass-dark p-4 rounded-lg card-hover animate-fade-in-up" style={{animationDelay: '0.3s'}} id="trust-stat-facilities">
              <span className="text-display text-3xl sm:text-4xl font-extrabold tracking-tight gradient-text font-mono">
                15+ Industries
              </span>
              <span className="text-[10px] uppercase tracking-[0.15em] text-slate-300 font-mono">
            ...
            <div className="flex flex-col gap-1 border-l-4 border-gradient-to-r from-brand-orange to-brand-accent pl-6 glass-dark p-4 rounded-lg card-hover animate-fade-in-up" style={{animationDelay: '0.4s'}} id="trust-stat-registered">
